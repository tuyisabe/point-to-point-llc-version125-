...
import PhoneInput from "../screens/lib/index";
        ...
        <View style={[styles.logo, { backgroundColor: MAIN_COLOR }]}>
          ...
          <Text
            style={[
              ...
              [
                isRTL
                  ? { marginRight: 25, textAlign: "right", padding: 8 }
              ...
              >
                ...
                >
                  ...
                  <RadioForm
                    ...
                    labelStyle={
                      [isRTL ? { marginRight: 10 } : { marginRight: 10 },{fontSize:20}]
                ...
                >
                  ...
                  >
                    ...
                    />
                    <TouchableOpacity
                      onPress={() => setEyeConfirmPass(!eyeConfirmPass)}
                    >
                      {eyeConfirmPass ? (
                        <Feather name="eye-off" size={20} color={colors.BLUE} />
                      ) : (
