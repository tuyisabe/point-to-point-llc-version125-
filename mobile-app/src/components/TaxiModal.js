      ...
      >
        <View style={styles.container}>
            ...
            {tripdata && tripdata.pickup && tripdata.drop ? (
              ...
              >
                ...
                tripdata.drop.waypoints.length > 0
                  ? tripdata.drop.waypoints.map((item, index) => {
                      return (
                        <Marker
                          coordinate={{
                            latitude: item.lat,
          ...
          tripdata.drop.waypoints.length > 0 ? (
            <View
              style={[
                styles.addressBarMul,
                {
                  flexDirection: isRTL ? "row-reverse" : "row",
                  height: tripdata.drop.waypoints.length == 1 ? 100 : 120,
                },
              ]}
            >
              {tripdata && tripdata.pickup && tripdata.drop ? (
                <ScrollView
                  style={[styles.contentStyleMul]}
                    ...
                    <View style={{ width: "50%" }}>
                      <Input
                        ...
                        inputStyle={[
                          ...
                          { textAlign: isRTL ? "right" : "left", fontSize: 15 },
                        ]}
                        onChangeText={(text) => {
                    ...
                    <View style={styles.totalFareContainer}>
                      <Text style={styles.totalFareText}>
                        {estimate && estimate.estimateDistance
                          ? parseFloat(estimate.estimateDistance).toFixed(
                              settings.decimal
                            )
                          : 0}{" "}
                        {settings && settings.convert_to_mile
                          ? t("mile")
                          : t("km")}{" "}
                      </Text>
                    </View>
