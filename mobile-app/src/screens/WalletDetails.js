  ...
  return (
    <View style={styles.mainView}>
      <View style={styles.Vew}>
        <View style={[styles.View6, { backgroundColor: MAIN_COLOR }]}>
          {settings.swipe_symbol === false ? (
            ...
            >
              ...
              {profile && profile.hasOwnProperty("walletBalance")
                ? parseFloat(profile.walletBalance).toFixed(settings.decimal)
                : ""}
            </Text>
          ) : (
            <Text
          ...
          (profile.usertype == "driver" ||
            ...
            >
              <View style={[styles.Vew1, { backgroundColor: colors.WHITE }]}>
                <TouchableOpacity onPress={doReacharge} style={styles.vew7}>
                  ...
                  />
                  <Text
                    style={[styles.txt, { color: colors.DRIVER_TRIPS_BUTTON }]}
                  >
                    {t("add_money")}
                  </Text>
                </TouchableOpacity>
      ...
      <View style={styles.Vew4}>
        <Text style={[styles.View5, { textAlign: isRTL ? "right" : "left" }]}>
          {t("transaction_history_title")}
        </Text>
        <WTransactionHistory
          walletHistory={walletHistory ? walletHistory : []}
          role={
            auth.profile && auth.profile.usertype ? auth.profile.usertype : null
          }
        />
      </View>
    </View>
