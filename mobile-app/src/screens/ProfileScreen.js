                    ...
                    {langSelection && languagedata && languagedata.langlist && languagedata.langlist.length > 1 ?
                        <View style={[styles.myViewStyle, { flexDirection: isRTL ? 'row-reverse' : 'row' }]}>
                            ...
                            <View style={[styles.flexView1, { alignSelf: isRTL ? 'flex-end' : 'flex-start', }]}>
                                <Text style={[styles.text1, [isRTL ? {textAlign: 'right',marginRight: 15 } : null]]}>{t('lang')}</Text>
                                {langSelection ?
                                    <RNPickerSelect
                                        ...
                                        style={{
                                            inputIOS: [styles.pickerStyle, [isRTL ? { marginRight: 0, textAlign: 'right' } : {textAlign: 'left' }]],
                                            inputAndroid: [styles.pickerStyle1, [isRTL ? { marginRight: 0 , textAlign: 'right'} : {textAlign: 'left' }]],
                                            placeholder: {
                                                color: colors.PROFILE_PLACEHOLDER_CONTENT
                                            }
                                        }}
