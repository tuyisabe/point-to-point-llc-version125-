  ...
  return (
    <View style={[styles.mainViewStyle, { backgroundColor: MAIN_COLOR }]}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          <Text
            style={[styles.Drivername, { textDecorationLine: "underline" }]}
          >
            {t("receipt")}
          </Text>
                    ...
                    <View key={"key" + index}>
                      ...
                      >
                        ...
                        <Text
                          numberOfLines={2}
                          style={[
                            styles.addressViewTextStyleMul,
                            { textAlign: isRTL ? "right" : "left" },
                          ]}
                        >
                          {point.add}
          ...
          >
            <Text
              style={[
                { fontSize: 18 },
                isRTL ? { marginRight: 18 } : { marginLeft: 18 },
              ]}
            >
              {t("date_time")}
            </Text>
            <View>
              <Text style={styles.dateViewTextStyle}>
                {booking && booking.tripdate
                  ? moment(booking.tripdate).format("MMM d,Y, hh:mm A")
                  : null}
              </Text>
            </View>
          </View>
        ...
        <View style={styles.ratingViewStyle}>
          <StarRating
            ...
            style={[
              isRTL
                ? { marginRight: 0, transform: [{ scaleX: -1 }] }
                : { scaleX: 1 },
            ]}
          />
        </View>
        ...
        <View style={styles.confBtnStyle}>
          ...
          <TouchableOpacity onPress={() => skipRating()}>
            <Text style={{ color: colors.HEADER, fontSize: 18 }}>
              {t("skip")}
            </Text>
          </TouchableOpacity>
        </View>
