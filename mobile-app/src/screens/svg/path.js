...
export const getPath = (width, iHeight, centerWidth, borderTopLeftRight = false) => {
    ...
    const curved = shape
        ...
        { x: (width - circleWidth) / 2 - scale(2), y: 0 },
        { x: (width - circleWidth) / 2 - scale(2), y: scale(2) },
        ...
        { x: width / 2 + scale(10), y: height / 2 + scale(10) },
        { x: width / 2 + circleWidth / 2 - scale(8), y: height / 2 + scale(2) },
        { x: (width - circleWidth) / 2 + circleWidth, y: scale(17) },
        { x: (width - circleWidth) / 2 + circleWidth + scale(2), y: scale(10) },
        { x: (width - circleWidth) / 2 + circleWidth + scale(2), y: scale(2) },
        { x: (width - circleWidth) / 2 + circleWidth + scale(2), y: 0 },
    ], line);
...
export const getPathUp = (width, iHeight, centerWidth = 50, borderTopLeftRight = false) => {
    const height = scale(iHeight);
