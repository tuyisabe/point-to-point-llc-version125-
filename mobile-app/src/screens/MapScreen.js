...
export default function MapScreen(props) {
  ...
  const [toairportSelected, setToairportSelected] = useState(true);
  ...
  useEffect(() => {
    if (settings && providers) {
      let arr = [{ label: t("cash"), value: 0, cat: "cash" }];
      let val = 0;
  ...
  useEffect(() => {
    if (
      (tripdata.pickup && tripdata.pickup.source == "gps") ||
      (tripdata.pickup && tripdata.pickup.source == "init")
    ) {
      setCurrentLocation(tripdata.pickup);
    }
  }, [tripdata]);
  const resetCars = () => {
    if (cars) {
  ...
  const onPressBookLater = () => {
    ...
    if (tripdata.drop.add == tripdata.pickup.add) {
      Alert.alert(
        t("alert"),
        "Your Pickup address should be different to Drop off Address! Try again please and choose the correct address"
      );
    } else {
      if (parseFloat(profile.walletBalance) >= 0) {
        if (!(profile.mobile && profile.mobile.length > 6)) {
  ...
  const reloadLocation = () => {
    ...
    if (tripdata.pickup && tripdata.pickup.source == "search") {
      tripdata.pickup = currentLocation;
    }
  };
      ...
      <View style={styles.mapcontainer}>
        ...
        {tripdata.selected == "pickup" ? (
          ...
          >
            ...
            >
              <Icon name="gps-fixed" color={colors.BLUE} size={33} />
            </TouchableOpacity>
          </View>
        ) : null}
        {locationRejected ? (
        ...
        <>
          ...
          >
            ...
            >
              ...
              >
                <Icon
                  name={toairportSelected ? "airplane-takeoff" : "magnify"}
                  type="material-community"
                  size={35}
                  color={colors.BLUE}
                  style={{
                ...
                >
                  ...
                  (toairportSelected &&
                    ...
                    currentLocation.add == tripdata.pickup.add) ? (
                    <Text
                      style={[
                        styles.textStyle,
                        tripdata.selected == "pickup"
        ...
        >
          <View
            style={{
              ...
              alignItems: "center",
              position: "absolute",
              bottom: height >= 600 ? height / 2.73 : height / 2.4,
              zIndex: 20,
              width: height / 13,
              height: height / 13,
              borderRadius: 80 / 2,
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {prop.name === "MiniVan" && "6"}
                            {prop.name === "Full Size SUV" && "6"}
                            {prop.name === "Full Size Van" && "10"}
                          </Text>
                        </View>
                        ...
                        >
                          {isRTL ? null : settings.swipe_symbol === false ? (
                            ...
                            >
                              {settings.symbol}
                              {prop.min_fare} /{" "}
                              {settings.convert_to_mile ? "min" : t("km")}{" "}
                            </Text>
                          ) : (
                            <Text
                              style={[
          ...
          >
            {bookLoading ? null : (
              <Button
                title={"Schedule SLC Airport Shuttle Now"}
                ...
                buttonStyle={[
                  ...
                  {
                    backgroundColor: colors.BLUE,
                    marginRight: bookLaterLoading ? 0 : 0,
                    marginLeft: bookLaterLoading ? 0 : 0,
                    paddingRight: 0,
                    width: bookLaterLoading ? width + 20 : width / 1.07,
                    height: bookLaterLoading ? 50 : 50,
                    borderRadius: bookLaterLoading ? 0 : 25,
                    marginBottom: bookLaterLoading ? -20 : 0,
                  },
                ]}
                containerStyle={[
                  styles.buttonContainer,
                  {
                    marginLeft: bookLaterLoading ? 0 : 15,
                    justifyContent: "center",
                    alignItems: "center",
                  },
                ]}
        ...
        >
          <View
            style={{
              ...
              alignItems: "center",
              position: "absolute",
              bottom: height <= 600 ? height / 10 : height / 30,
              zIndex: 20,
              width: height / 13,
              height: height / 13,
              borderRadius: 80 / 2,
...
const styles = StyleSheet.create({
  ...
  addressBar: {
    position: "absolute",
    marginHorizontal: 20,
    top: Platform.OS == "android" ? (__DEV__ ? 125 : 125) : hasNotch ? 95 : 95,
    height: 70,
    width: width - 40,
    flexDirection: "row",
    backgroundColor: colors.WHITE,
  ...
  addressBar1: {
    ...
    marginHorizontal: 20,
    top:
      Platform.OS == "android" ? (__DEV__ ? 205 : 205) : hasNotch ? 175 : 175,
    height: 70,
    width: width - 40,
    flexDirection: "row",
    backgroundColor: colors.WHITE,
