  ...
  const columns = [
    {
      ...
      render: (rowData) =>
        rowData.createdAt
          ? moment(rowData.createdAt).format("MMM d,Y, hh:mm A")
          : null,
  ...
  return carlistdata.loading ? (
    ...
    <div ref={rootRef}>
      <MaterialTable
              ...
              ? new Promise((resolve, reject) => {
                  setTimeout(() => {
                    if (
                      ...
                      let selectDriver =
                        role === "admin" ? newData.driver : auth.profile.uid;
                      let activeCar = null;
                      let updateData = {
                      ...
                      newData["fleetadmin"] = newData["driver"]
                        ? fleetMapObj[newData["driver"]]
                          ? fleetMapObj[newData["driver"]]
                          : null
                        : null;
                      if (!settings.carApproval) {
                        ...
                        if (newData.active) {
                          dispatch(
                            updateUserCar(newData.driver, { carApproved: true })
                          );
                        }
                      } else {
              ...
              ? new Promise((resolve) => {
                  setTimeout(() => {
                    ...
                    if (newData !== oldData) {
                      ...
                      newData["fleetadmin"] = newData["fleetadmin"]
                        ? fleetMapObj[newData["driver"]]
                        : null;
        ...
        actions={[
          (rowData) =>
            settings.carApproval && role === "admin"
              ? {
                  icon: () =>
                    rowData.approved ? (
                      <div
                  ...
                  onClick: (event, rowData) => {
                    ...
                    dispatch(
                      editCar(
                        { ...rowData, approved: !rowData.approved },
                        "Update"
                      )
                    );
                  },
