...
export default function Promos() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (rowData) =>
        rowData.promo_validity
          ? moment(rowData.promo_validity).format("MMM d,Y, hh:mm A")
          : null,
      cellStyle: { textAlign: "center", width: 200 },
      headerStyle: { textAlign: "center" },
    },
    {
      title: t("promo_usage"),
          ...
          new Promise((resolve, reject) => {
            setTimeout(() => {
              if (
                !(
                  newData.promo_name &&
                  newData.promo_description &&
                  newData.promo_discount_value &&
                  newData.promo_discount_type &&
                  newData.promo_discount_value &&
                  newData.max_promo_discount_value &&
                  newData.min_order &&
                  newData.promo_usage_limit &&
                  newData.min_order >= newData.max_promo_discount_value &&
                  newData.promo_discount_value >=
                    newData.max_promo_discount_value
                )
              ) {
                ...
                newData["promo_validity"] = newData.promo_validity
                  ? new Date(newData.promo_validity).getTime()
                  : null;
