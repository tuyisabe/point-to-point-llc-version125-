...
export const bookingHistoryColumns = (role, settings, t, isRTL) => [
  {
    title: t("booking_id"),
    field: "id",
    cellStyle: isRTL === "rtl" ? { paddingRight: 220 } : { paddingLeft: 220 },
    headerStyle: isRTL === "rtl" ? { paddingRight: 220 } : { paddingLeft: 220 },
  },
  {
    title: t("booking_ref"),
    field: "reference",
  ...
  },
  {
    ...
    render: (rowData) =>
      rowData.bookingDate
        ? moment(rowData.bookingDate).format("MMM d,Y, hh:mm A")
        : null,
    cellStyle: { textAlign: isRTL === "rtl" ? "right" : "left" },
  },
  {
    ...
    render: (rowData) =>
      rowData.tripdate
        ? moment(rowData.tripdate).format("MMM d,Y, hh:mm A")
        : null,
    cellStyle: { textAlign: isRTL === "rtl" ? "right" : "left" },
  },
  {
  ...
  {
    title: t("cancellationFee"),
    render: (rowData) => (
      <span>
        {rowData.cancellationFee
          ? rowData.cancellationFee
  ...
  {
    title: t("trip_cost_driver_share"),
    hidden: role === "customer" ? true : false,
    field: "driver_share",
    cellStyle: { textAlign: isRTL === "rtl" ? "right" : "left" },
  },
  {
  ...
  {
    title: t("cash_payment_amount"),
    field: "cashPaymentAmount",
    cellStyle: { textAlign: isRTL === "rtl" ? "right" : "left" },
  },
  {
    title: t("card_payment_amount"),
    field: "cardPaymentAmount",
    cellStyle: { textAlign: isRTL === "rtl" ? "right" : "left" },
  },
  {
    title: t("wallet_payment_amount"),
...
export const carTypeColumns = (t, isRTL, onClick) => [
  {
    ...
    cellStyle:
      isRTL === "rtl"
        ? { paddingRight: 100, textAlign: "right" }
        : { paddingLeft: 100 },
    headerStyle: isRTL === "rtl" ? { paddingRight: 100 } : { paddingLeft: 100 },
  },
  {
    title: t("image"),
    field: "image",
